...
// import type { AttractionCard, SelectedCard } from "./types"
...
//   onSelect: (c: AttractionCard) => void
...
//               const badgeLabels = attraction.category
//                 .split(",")
//                 .map((s) => s.trim())
//                 .filter(Boolean)
//                 .slice(0, 2)
//               const isLongTitle = (attraction.title || "").length > 36
//               const cardWidth = isLongTitle ? "360px" : badgeLabels.length > 1 ? "360px" : "280px"
//               const isSelected = selectedCard?.id === attraction.id
...
//                     style={{ width: "120px", height: "170px", objectFit: "cover", flexShrink: 0 }}
//                   />
//                   <Box
//                     sx={{
//                       padding: "16px",
...
export function AttractionsCarousel({
  ...
  items: AttractionCard[]
  selectedCard: SelectedCard | null
  onSelect: (card: AttractionCard) => void
}) {
